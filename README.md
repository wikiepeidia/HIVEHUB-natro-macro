...
This repository is a fork/customization of Natro Macro. For the Trading Hub / hub field work in this fork, we also want to explicitly credit [huner2/NatroMacro/tree/hub_field_addition](https://github.com/huner2/NatroMacro/tree/hub_field_addition) as a reference implementation, since several functions and behavior patterns used here were adapted from that branch.
